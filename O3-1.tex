...
R.~Lynne~Jones,$^1$
J.~Bryce~Kalmbach,$^1$
Vishal~P.~Kasliwal,$^{5,10}$
K.~Simon~Krughoff,$^1$
Robert~H.~Lupton,$^5$
John~Lurie,$^1$
Nate~B.~Lust,$^5$
Lauren~A.~MacArthur,$^5$
Joachim~Moeyens,$^1$
David~L.~Nidever,$^{2,11}$
Russell~Owen,$^1$
John~K~Parejko,$^1$
J.~Matt~Peterson,$^2$
Donald~Petravick,$^6$
Stephen~R.~Pietrowicz,$^6$
Paul~A.~Price,$^5$
David~J.~Reiss,$^1$
Richard~A.~Shaw,$^{12}$
Jonathan~Sick,$^2$
...
\affil{$^4$Astronomical Observatory, Belgrade, Serbia}
\affil{$^5$Princeton University, Princeton, NJ, U.S.A.}
\affil{$^6$National Center for Supercomputing Applications, Urbana, IL, U.S.A.}
\affil{$^7$Brookhaven National Laboratory, Upton, NY, U.S.A.}
\affil{$^8$IN2P3 Computing Center, CNRS, Lyon-Villeurbanne, France}
\affil{$^9$LPC, IN2P3, Clermont-Ferrand, France}
\affil{$^{10}$University of Pennsylvania, Philadelphia, PA, U.S.A.}
\affil{$^{11}$University of Arizona, Tucson, AZ, U.S.A.}
\affil{$^{12}$NOAO, Tucson, AZ, U.S.A.}
}
...
(uncompressed) processed data set of approximately 500 petabytes at the end of its
...
near real time, with full-dataset reprocessings occuring annualy.
...
database \citep{LDM-135} and user interface components \citep{LDM-131}.
