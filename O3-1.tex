...
\affil{$^5$Astronomical Observatory, Volgina 7, 11060 Belgrade, Serbia}
\affil{$^6$NOAO, Tucson, AZ, U.S.A.}
\affil{$^7$Department of Astrophysical Sciences, Princeton University, Princeton, NJ 08544, USA}
\affil{$^8$Department of Physics, Brookhaven National Laboratory, Bldg. 510, Upton, NY, 11792, USA}
\affil{$^9$Department of Physics and Astronomy, Center for Particle Cosmology, University of Pennsylvania, 209 S. 33rd St., Philadelphia, PA 19104, USA}
\affil{$^{10}$LPC, IN2P3, Clermont-Ferrand, France}
\affil{$^{11}$National Center for Supercomputing Applications, University of Illinois at Urbana-Champaign, Urbana IL, USA}
}
...
\paperauthor{Frossie~Economou}{frossie@lsst.org}{0000-0002-8333-7615}{LSST}{Data Management}{Tucson}{AZ}{85719}{USA}
\paperauthor{Angelo~Fausti}{afausti@lsst.org}{0000-0002-8095-305X}{LSST}{Data Management}{Tucson}{AZ}{85719}{USA}
\paperauthor{Jonathan~Sick}{jsick@lsst.org}{0000-0003-3001-676X}{LSST}{Data Management}{Tucson}{AZ}{85719}{USA}
\paperauthor{Joshua~Hoblitt}{jhoblitt@lsst.org}{}{LSST}{Data Management}{Tucson}{AZ}{85719}{USA}
\paperauthor{J.~Matt~Peterson}{jpeterson2@lsst.org}{}{LSST}{Data Management}{Tucson}{AZ}{85719}{USA}
