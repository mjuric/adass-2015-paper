...
\paperauthor{J.~Bryce~Kalmbach}{jbkalmbach@gmail.com}{}{University of Washington}{Department of Astronomy}{Seattle}{WA}{98195}{USA}
...
The Large Synoptic Survey Telescope (LSST; \url{http://lsst.org}) is a
planned, large-aperture, wide-field, ground-based telescope that will survey
approximately $10,000$~deg$^2$ of the sky every few nights in six optical bands from
320 to 1050 nm.  It will explore a wide range of astrophysical questions,
...
data reduction pipeline.  In the 2020's, running on dedicated HPC
facilities, this system will enable us to process the LSST data stream in
near real time, with full-dataset reprocessings annualy.
...
to 1050\,nm \citep{2008arXiv0805.2366I}, covering about $18,000$~deg$^2$
over $800$~times over its 10-year lifetime. It will explore a wide range of 
...
2020's, running on dedicated HPC facilities, this system will enable us to
...
\begin{itemize}
\item Process, in real time, the incoming stream of images generated by the camera system during observing by archiving raw images, generating alerts to new sources or sources whose properties have changed significantly, and updating the relevant catalogs (``Level 1'' data products; \S~\ref{Sec:dp}).
...
not qualify for the top 500 list by the time of first light, and carry
an small technological risk to the project.
\\
...
processing. Once completed, it will comprise of
...
Pan-STARRS, DES,
SuperMACHO, ESSENCE,  DLS, CFHTLS, and UKIDSS) and software tools (e.g.,
SExtractor). The pipelines written
...
Its open source nature, an open development process, a long-term project
commitment and a design that can be modified for use with other cameras
may make it useful for the processing of imaging data beyond LSST.
For example, the LSST software stack forms the basis for the data
processing pipelines of the Subaru Hyper-Suprime Cam Survey \citep{XXXX}.
