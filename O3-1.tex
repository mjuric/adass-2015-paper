...
\author{Mario~Juric,$^1$ Jeffrey Kantor,$^2$, K-T~Lim$^3$ Darko
  Jevremovi\'c$^4$, Veljko Vuj\v ci\'c$^4$, Jovan Aleksi\'c$^4$
...
\affil{$^4$ Astronomical Observatory, Volgina 7, 11060 Belgrade Serbia; \email{darko,veljko,jaleksic@aob.rs}}}
