...
the sky in six optical bands from 320 to 1050 nm, covering approximately
$10,000$~deg$^2$ every few nights. The LSST telescope is currently under
construction on Cerro Pach\'{o}n in Chile, and expected to enter operations
in 2022. Once operational, the LSST will explore a wide range of 
astrophysical questions, ranging from discovering ``killer'' asteroids,
...
Section~\ref{sec:dm}. In Section~\ref{sec:dmstack}, we discuss the software
stack being developed for processing and serving of LSST data. In
Section~\ref{sec:dp}, we discuss the resulting data products. We 
conclude by discussing opportunities this new codebase 
...
The data processing center will have substantial computing
...
custom data products not created by standard LSST processing \citep[e.g., see
Section 6 of][]{DPDD}. These
...
to quickly build such codes. Also, approximately 10\% of the total
